            ...
            if o_courier in range(len(couriers_list)):
                ...
                while True:
                    try:
                        ...
                        def is_index_valid(products_list, o_items):
                            for idx in o_items:
                                try:
                                    products_list[idx]
                                    ...
                                    return False
                            return True
                        if is_index_valid(products_list, o_items) is True:
                            ...
                            print("\n Order logged and status set to 'PREPARIG'...")
                            time.sleep(2)
                            break
                        else:
                            print("\n Selected products out of range. Please try again...")
                            time.sleep(0.5)  
                    except ValueError:
...
def order_updt(product_list: List, couriers_list: List, orders_list: List, order_status_list: List):
    while True:
        try:
            os.system('cls')
            index_view('order', orders_list)
            ...
            if x in range(len(orders_list)):
                while True:
                    ...
                    if keys[dict_choice] == 'courier':
                        ...
                        index_view('product',product_list)
                        ...
                        # if o_items == "":
                        if all(item in o_items for item in range(len(product_list))) == True:
